 ...
 *
 * Replaces three parallel arrays (titles, authors, copiesAvailable) with a
 * single class so the three pieces of data can never drift out of sync again.
 */
public class BookInventory {
    ...
    /** Prints one formatted line describing this inventory entry. */
